...
void printSolveMazeMenu(void){
    ...
    std::cout << "3) Show Escape Route (Using BFS)" << std::endl;
...
void printTeamInfo(void){
    ...
    std::cout << "\t [1] Khanh Nguyen (s4090097@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [2] Jason Xu (s4094183@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [3] Brian Chau (s4100533@student.rmit.edu.au)" << std::endl;
    std::cout << std::endl;
}
